...
result = HJSolver(
    my_car, g, Initial_value_f, tau, compMethods, po2, saveAllTimeSteps=True
)
...
v_derivative = computeSpatDerivArray(
...
spat_deriv_vector = (
    ...
    v_derivative[10, 20, 15, 15],
    T_derivative[10, 20, 15, 15],
)
...
# HJSolver(dynamics object, grid, initial value function, time length, system objectives, plotting options)
result = HJSolver(
    my_car, g, [goal, obstacle], tau, compMethods, po2, saveAllTimeSteps=False
)
